...
class UploadAssets extends Component {
    ...
    static getDerivedStateFromProps(state, props){
        if(props.assetfilesmessage){
            return{
                fileerrormessage:props.assetfilesmessage
            }
        }
        else{
            return{
    ...
    UploadFiles(e){
        ...
        if(this.state.uploadedfiles){
            ...
            this.setState({
                files:[],
                uploadedfiles:null,
                fileerrormessage:'Select Atleat One File to Upload',
            })
        }
    }
                        ...
                        <Col xs={12} sm={12} md={12}>
                            <Row>
                                <Col xs={12} sm={12} md={12}>
                                    ...
                                    <AlertDismisable message={(this.props.assetfilesmessage && this.props.assetfilesmessage !== '') ? this.props.assetfilesmessage : this.state.fileerrormessage } color={(this.props.code === 1) ? 'success' : 'danger'}/>
                                    <div className="">
