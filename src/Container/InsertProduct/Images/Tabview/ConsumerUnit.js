            ...
            <div className="row">
                <div className="col-sm-6 col-md-10 col-md-offset-1">
                    <div className="upload_image text-center">
                        <AlertDismisable message={ this.props.cu_image_type_error } color='danger'/>
                        <div className="form-group image_upload upload_assets">
                            <FileBase64 multiple={true} onDone={ this.props.getFiles.bind(this,'cu') } />
                            <div className={(this.props.cu_image_preview.length) ? 'uploaded_image_count' : 'uploaded_image_count hide'}>
                                You have chosen   {this.props.cu_image_preview.length} images
                            </div>
                            <div id="image_preview" className={(this.props.cu_image_preview) ? '' : 'hide'}>
                                    {this.props.cu_image_preview}
                            </div>
                        </div>
                    </div>
                </div>
