...
const FeatureBenifits = (props) => {
    ...
    if(props.details.hasOwnProperty('pallet_features1') && (props.details['pallet_features1']) !== ''  && (props.details['pallet_features1']) !== null){
        details_main = details_main + '<li>'+props.details['pallet_features1']+'</li>';
    }

    if(props.details.hasOwnProperty('pallet_features2') && (props.details['pallet_features2']) !== ''  && (props.details['pallet_features2']) !== null){
        details_main = details_main + '<li>'+props.details['pallet_features2']+'</li>';
    }


    if(props.details.hasOwnProperty('pallet_features3') && (props.details['pallet_features3']) !== ''  && (props.details['pallet_features3']) !== null){
        details_main = details_main + '<li>'+props.details['pallet_features3']+'</li>';
    }

    if(props.details.hasOwnProperty('pallet_features4') && (props.details['pallet_features4']) !== ''  && (props.details['pallet_features4']) !== null){
        details_main = details_main + '<li>'+props.details['pallet_features4']+'</li>';
    }

    if(props.details.hasOwnProperty('pallet_features5') && (props.details['pallet_features5']) !== ''  && (props.details['pallet_features5']) !== null){
        details_main = details_main + '<li>'+props.details['pallet_features5']+'</li>';
    }

    if(props.details.hasOwnProperty('pallet_features6') && (props.details['pallet_features6']) !== ''  && (props.details['pallet_features6']) !== null){
