...
const FeatureBenifits = (props) => {
    ...
    if(props.details.hasOwnProperty('cu_features1') && (props.details['cu_features1']) !== ''  && (props.details['cu_features1']) !== null){
        details_main = details_main + '<li>'+props.details['cu_features1']+'</li>';
    }

    if(props.details.hasOwnProperty('cu_features2') && (props.details['cu_features2']) !== ''  && (props.details['cu_features2']) !== null){
        details_main = details_main + '<li>'+props.details['cu_features2']+'</li>';
    }


    if(props.details.hasOwnProperty('cu_features3') && (props.details['cu_features3']) !== ''  && (props.details['cu_features3']) !== null){
        details_main = details_main + '<li>'+props.details['cu_features3']+'</li>';
    }

    if(props.details.hasOwnProperty('cu_features4') && (props.details['cu_features4']) !== ''  && (props.details['cu_features4']) !== null){
        details_main = details_main + '<li>'+props.details['cu_features4']+'</li>';
    }

    if(props.details.hasOwnProperty('cu_features5') && (props.details['cu_features5']) !== ''  && (props.details['cu_features5']) !== null){
        details_main = details_main + '<li>'+props.details['cu_features5']+'</li>';
    }

    if(props.details.hasOwnProperty('cu_features6') && (props.details['cu_features6']) !== ''  && (props.details['cu_features6']) !== null){
