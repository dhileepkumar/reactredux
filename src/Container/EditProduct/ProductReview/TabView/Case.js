...
const FeatureBenifits = (props) => {
    ...
    if(props.details.hasOwnProperty('case_features1') && (props.details['case_features1']) !== ''  && (props.details['case_features1']) !== null){
        details_main = details_main + '<li>'+props.details['case_features1']+'</li>';
    }

    if(props.details.hasOwnProperty('case_features2') && (props.details['case_features2']) !== ''  && (props.details['case_features2']) !== null){
        details_main = details_main + '<li>'+props.details['case_features2']+'</li>';
    }


    if(props.details.hasOwnProperty('case_features3') && (props.details['case_features3']) !== ''  && (props.details['case_features3']) !== null){
        details_main = details_main + '<li>'+props.details['case_features3']+'</li>';
    }

    if(props.details.hasOwnProperty('case_features4') && (props.details['case_features4']) !== ''  && (props.details['case_features4']) !== null){
        details_main = details_main + '<li>'+props.details['case_features4']+'</li>';
    }

    if(props.details.hasOwnProperty('case_features5') && (props.details['case_features5']) !== ''  && (props.details['case_features5']) !== null){
        details_main = details_main + '<li>'+props.details['case_features5']+'</li>';
    }

    if(props.details.hasOwnProperty('case_features6') && (props.details['case_features6']) !== ''  && (props.details['case_features6']) !== null){
        ...
        return (
            <div className="row">
                <div className="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <CarouselComponent images={(this.props.product_details.hasOwnProperty('case_image') && this.props.product_details.case_image) ? this.props.product_details.case_image : this.props.images} />
                    </div>
                </div>
