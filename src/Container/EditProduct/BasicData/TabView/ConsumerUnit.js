...
class ConsumerUnit extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        if (props.form_data.hasOwnProperty('cu_gtin_code') && !state.selections_loaded) {
            if (props.form_data.cu_category_name !== '') {
                var sub_category_values = {
                    token: props.token,
                    parent_category: props.form_data.cu_category_name
                }
                props.SubCategoryList(sub_category_values, 'cu');
            }
            if (props.form_data.cu_sub_category_name !== '') {
                var market_values = {
                    token: props.token,
                    sub_category_name: props.form_data.cu_sub_category_name
                }
                props.MarketList(market_values, 'cu');
            }

            return {
                selections_loaded: true,
                cat_selected: props.form_data.cu_category_name,
                subcat_selected: props.form_data.cu_sub_category_name,
                market_selected: props.form_data.cu_market_name,
                        ...
                        <div className="pdform_column">
                            <div className="row">
                                <div className="col-xs-12 col-sm-6 col-md-6">
                                    <div className="form-group">
                                        <label>GTIN</label>
                                        <Field name="cu_gtin_code" component="input" readOnly type="text" id="cu_gtin_code" className="form-control" tabbrand="cu" onBlur={this.props.handleChange.bind(this, 'cu')} />
                                    </div>
                                </div>
                                <div className="col-xs-12 col-sm-6 col-md-6">
                                    <div className="form-group">
