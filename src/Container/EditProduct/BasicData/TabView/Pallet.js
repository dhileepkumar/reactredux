...
export default class Pallet extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        if (props.form_data.hasOwnProperty('pallet_gtin_code') && !state.selections_loaded) {
            if (props.form_data.pallet_category_name !== '') {
                var sub_category_values = {
                    token: props.token,
                    parent_category: props.form_data.pallet_category_name
                }
                props.SubCategoryList(sub_category_values, 'pallet');
            }
            if (props.form_data.pallet_sub_category_name !== '') {
                var market_values = {
                    token: props.token,
                    sub_category_name: props.form_data.pallet_sub_category_name
                }
                props.MarketList(market_values, 'pallet');
            }

            return {
                selections_loaded: true,
                cat_selected: props.form_data.pallet_category_name,
                subcat_selected: props.form_data.pallet_sub_category_name,
                market_selected: props.form_data.pallet_market_name,
                        ...
                        <div className="pdform_column">
                            <div className="row">
                                <div className="col-xs-12 col-sm-6 col-md-6">
                                    <div className="form-group">
                                        <label>GTIN</label>
                                        {/* <Field name="pallet_gtin_code" component="input" type="text" id="pallet_gtin_code" className="form-control" onBlur={this.props.handleChange.bind(this,'pallet')}/> */}
                                        {(this.props.form_data.hasOwnProperty('pallet_gtin_code') && this.props.form_data.pallet_gtin_code) ?
                                            <Field name="pallet_gtin_code" component="input" readOnly type="text" id="pallet_gtin_code" className="form-control" onBlur={this.props.handleChange.bind(this, 'pallet')} />
                                            :
