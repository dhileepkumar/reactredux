...
export default class Case extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        if (props.form_data.hasOwnProperty('case_gtin_code') && !state.selections_loaded) {
            if (props.form_data.case_category_name !== '') {
                var sub_category_values = {
                    token: props.token,
                    parent_category: props.form_data.case_category_name
                }
                props.SubCategoryList(sub_category_values, 'case');
            }
            if (props.form_data.case_sub_category_name !== '') {
                var market_values = {
                    token: props.token,
                    sub_category_name: props.form_data.case_sub_category_name
                }
            ...
            return {
                ...
                cat_selected: props.form_data.case_category_name,
                subcat_selected: props.form_data.case_sub_category_name,
                                ...
                                <div className="col-xs-12 col-sm-6 col-md-6">
                                    <div className="form-group">
                                        ...
                                        {(this.props.form_data.hasOwnProperty('case_gtin_code') && this.props.form_data.case_gtin_code) ?
                                            <Field name="case_gtin_code" component="input" readOnly type="text" id="case_gtin_code" className="form-control" onBlur={this.props.handleChange.bind(this, 'case')} />
                                            :
